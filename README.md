...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Formulário  RM</title>
    <style>
        body{
            font-family: Arial, Helvetica, sans-serif;
            background-image: linear-gradient(to right, rgb(180, 20, 220), rgb(51, 17, 71));
        }
        .box{
            color: white;
            position: absolute;
        ...
        fieldset{
            border: 3px solid rgb(218, 30, 255);
        }
        legend{
            border: 1px solid rgb(146, 30, 255);
            padding: 10px;
            text-align: center;
            background-color: rgb(218, 30, 255);
            border-radius: 8px;
        }
        .inputBox{
            position: relative;
